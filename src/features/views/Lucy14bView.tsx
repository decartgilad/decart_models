...
import { ModelHeader, Stage, PromptRail } from '@/ui/design-system'

export default function Lucy14bView({ model }: ModelViewProps) {
  // Use existing hooks
  ...
  const handlePromptSubmit = React.useCallback(async (prompt: string, file: File) => {
    ...
    try {
      ...
      // Create job with real uploaded file
      jobCreation.createJobWithModel(uploadResult, prompt)
  ...
  return (
    <div className="space-y-xl">
      ...
      {/* Prompt Rail from design system */}
      <PromptRail
